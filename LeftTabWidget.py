...
class LeftTabWidget(QWidget):
    ...
    def __init__(self):
        ...
        #self.setWindowFlags(Qt.FramelessWindowHint)  # 隐藏窗体边框
        self.setWindowTitle('LeftTabWidget')
        with open('D:/python/code/qilucontest/qt/test/QSS/QListWidgetQSS.qss', 'r') as f:   #导入button的qss样式
    ...
    def _setup_ui(self):
        ...
        for i in range(4):
            ...
            self.browser.setUrl(QUrl.fromLocalFile('D://python//code//qilucontest//vision//%s' % url_list[i]))
